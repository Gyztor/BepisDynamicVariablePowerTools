...
2. Download the latest release ZIP file (e.g., `BowenArrows-BowenArrowsMod-1.0.0.zip`) from the [Releases](https://github.com/BowenArrows/BowenArrowsMod/releases) page.
