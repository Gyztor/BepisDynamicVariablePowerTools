...
2. Download the latest release ZIP file (e.g., `BowenArrows2K-BowenArrowsMod-1.0.0.zip`) from the [Releases](https://github.com/BowenArrows2K/BowenArrowsMod/releases) page.
